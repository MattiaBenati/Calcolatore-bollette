...
public class InputGas {
    ...
    {
        Main.clearConsole();
        System.out.println(Main.creaTitolo("INSERIMENTO DATI BOLLETTA GAS"));
        
        while (true)
        {
            System.out.print("Importo totale bolletta gas (€): ");
    ...
    private void stampaRiepilogo(boolean conNumeri)
    {
        ...
        if (conNumeri)
        {
            System.out.println("1 = Importo totale bolletta gas: " + importoTotale + " €");
        ...
        {
            System.out.println("Importo totale bolletta gas: " + importoTotale + " €");
